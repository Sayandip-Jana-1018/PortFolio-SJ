...
export const hackathonsData: HackathonProject[] = [
  ...
  },
  {
    id: "hack-4",
    name: "TechForge-25",
    position: "2nd Runner-Up & ₹5L Seed 🥉",
    date: "July 2025",
    location: "LPU, Jalandhar, Punjab",
    team: "Bytes & Bonds",
    teamSize: 2,
    project: "National Level Innovation Project",
    description: "Secured 2nd Runner-Up & ₹5L Seed Investment in SMG at the National Level Hackathon TechForge-25 hosted by LPU in association with HoverRobotix | MENTORx! A battlefield of code, caffeine, and creativity. Key learnings included quick ideation under pressure, agile collaboration, and targeted problem-solving for real-world applications.",
